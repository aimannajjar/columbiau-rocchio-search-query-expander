...
class BingClient:
    ...
    def webQuery(self, query):
        ...
        url_query = 'Query=' + '%27' + query + '%27' + '&$top=10&$format=JSON'
        #encode account key
        print 'Account Key: ' + self.__i_accountKey 
        
        accountKeyEnc = base64.b64encode(self.__i_accountKey + ':' + self.__i_accountKey)
        headers = {'Authorization': 'Basic ' + accountKeyEnc}
        full_query = constants.BING_URL + url_query
        print 'Sending following URL query: ' + full_query
